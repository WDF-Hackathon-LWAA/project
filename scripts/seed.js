// const {Resume, Seeker, Company, Position, db} = require('../server/db/models')

// const exampleSeekers = [
//   { email: 'lucy@email.com', industries: 'fintech', level: 'entry' },
//   { email: 'bob@email.com', industries: 'fintech', level: 'entry' },
//   { email: 'tom@email.com', industries: 'adtech', level: 'entry' },
...
// const positions = [
//   { title: 'Frontend Engineer', level: 'entry', description: 'a job where you do things', companyId: 1},
//   { title: 'Frontend Engineer', level: 'entry', description: 'a job where you do things', companyId: 1},
//   { title: 'Frontend Engineer', level: 'entry', description: 'a job where you do things', companyId: 2},
